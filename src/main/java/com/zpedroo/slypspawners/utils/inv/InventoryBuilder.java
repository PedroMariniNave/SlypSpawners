...
public class InventoryBuilder {
     ...
     * Constructor
     */
    public InventoryBuilder(Player player, Inventory defaultInventory, List<ItemBuilder> builders, Integer nextPageSlot, Integer previousPageSlot, ItemStack nextPageItem, ItemStack previousPageItem) {
        this.player = player;
     ...
     */
    public static InventoryBuilder build(Player player, Inventory defaultInventory, List<ItemBuilder> builders) {
        return build(player, defaultInventory, builders, null, null, null, null);
    }
     ...
     * @return InventoryBuilder
     */
    public static InventoryBuilder build(Player player, Inventory defaultInventory, List<ItemBuilder> builders, Integer nextPageSlot, Integer previousPageSlot, ItemStack nextPageItem, ItemStack previousPageItem) {
        return new InventoryBuilder(player, defaultInventory, builders, nextPageSlot, previousPageSlot, nextPageItem, previousPageItem);
    }
